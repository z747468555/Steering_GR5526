...
void lv_port_disp_init(void)
{
    ...
    lv_memset_00(_draw_buf1,DISP_HOR_RES * DISP_VER_RES * DISP_PIXEL_DEPTH);
    lv_memset_00(_draw_buf2,DISP_HOR_RES * DISP_VER_RES * DISP_PIXEL_DEPTH);
	psram_buf = (uint8_t*)_draw_buf1;
