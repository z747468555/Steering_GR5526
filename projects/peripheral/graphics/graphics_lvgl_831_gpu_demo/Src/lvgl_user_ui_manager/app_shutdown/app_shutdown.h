...
#define SCREEN_SHUTDOWN_PAGE \
    [SCREEN_ID_SHUTDOWN] = { \
        .attr_id_self             = SCREEN_ID_SHUTDOWN,\
        ...
        .attr_idle_timeout_target = SCREEN_ID_SHUTDOWN,\
        .p_obj_screen             = NULL,\
        .p_cache_addr             = NULL,\
        .screen_init              = shutdown_init,\
        .screen_release           = shutdown_release,\
        .screen_event             = NULL,\
