...
#define   GH3X2X_SAMPLE_LOG_PARAM(...)        do {\
                                                    ...
                                                    if(g_pPrintfUser)g_pPrintfUser("[gh3x2x_drv]: "__VA_ARGS__);\
                                            } while (0)
//bp log
#if (SAMPLE_DEBUG_ENABLE_BP)
#define   GH3X2X_DEBUG_LOG_PARAM_BP(...)    { GH3X2X_SAMPLE_LOG_PARAM(__VA_ARGS__); }
#else
#define   GH3X2X_DEBUG_LOG_PARAM_BP(...)
#endif
//agc log
#if (SAMPLE_DEBUG_ENABLE_AGC)
#define   GH3X2X_DEBUG_LOG_PARAM_AGC(...)   { GH3X2X_SAMPLE_LOG_PARAM(__VA_ARGS__); }
#else
#define   GH3X2X_DEBUG_LOG_PARAM_AGC(...)
#endif
#else
//sample log close
#define   GH3X2X_SAMPLE_LOG_PARAM(...)
#define   GH3X2X_DEBUG_LOG_PARAM_BP(...)
#define   GH3X2X_DEBUG_LOG_PARAM_AGC(...)
#endif
