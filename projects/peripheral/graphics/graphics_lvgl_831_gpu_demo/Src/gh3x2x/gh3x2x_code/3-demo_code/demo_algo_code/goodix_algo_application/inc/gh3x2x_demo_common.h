...
#if (__ALGO_LOG_CONFIG__ >= __GH3X2X_ALGO_LOG_LV_ERROR__)
#define   GH3X2X_ERROR_ALGO_LOG(...)         do {\
                                                        GCHAR chDebugStr[GH3X2X_LOG_ALGO_SUP_LEN] = {0};\
                                                        snprintf(chDebugStr, GH3X2X_LOG_ALGO_SUP_LEN, \
                                                                "[LOG_ALGO_E]: "__VA_ARGS__);\
                                                        GH3X2X_AlgoLog(chDebugStr);\
                                                    } while (0)
#else
#define   GH3X2X_ERROR_ALGO_LOG(...)
#endif

#if (__ALGO_LOG_CONFIG__ >= __GH3X2X_ALGO_LOG_LV_WARNING__)
#define   GH3X2X_WARNING_ALGO_LOG(...)         do {\
                                                        GCHAR chDebugStr[GH3X2X_LOG_ALGO_SUP_LEN] = {0};\
                                                        snprintf(chDebugStr, GH3X2X_LOG_ALGO_SUP_LEN, \
                                                                "[LOG_ALGO_W]: "__VA_ARGS__);\
                                                        GH3X2X_AlgoLog(chDebugStr);\
                                                    } while (0)
#else
#define   GH3X2X_WARNING_ALGO_LOG(...)
#endif


#if (__ALGO_LOG_CONFIG__ >= __GH3X2X_ALGO_LOG_LV_INFO__)
...
#if (__ALGO_LOG_CONFIG__ >= __GH3X2X_ALGO_LOG_LV_DEBUG__)
