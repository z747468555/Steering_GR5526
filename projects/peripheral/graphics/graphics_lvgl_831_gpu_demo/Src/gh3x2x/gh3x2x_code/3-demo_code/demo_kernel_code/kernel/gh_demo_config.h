...
#define __PLATFORM_WITHOUT_OS__             (1)         /**< 1:not use os  0:use os */
...
#define __DRIVER_LIB_MODE__                 (__DRV_LIB_WITH_ALGO__)	//¹Ø±ÕËã·¨	TODO
...
#define __GH_MULTI_SENSOR_TIMER_PERIOD_MS__              (100)     /** period of multi-sensor timer, unit: ms*/
#define __GH_MULTI_SENSOR_WEAR_EXAMPLE_EN__              (1)        /** this is example for using multi-senosr process to check wear on, you can set 1 to enable this example process*/
...
#define __GH3X2X_INFO_LOG_LEVEL__                       (__GH3X2X_INFO_LOG_LV_NB__) /**< example log config */
...
#define __GH3X2X_RAWDATA_BUFFER_SIZE__                  (300 * 4)     /**< rawdata buffer size in byte */
...
/* log def*/
#if (__GH3X2X_INFO_LOG_LEVEL__ >= __GH3X2X_INFO_LOG_LV_ERROR__)
...
#if (__GH3X2X_INFO_LOG_LEVEL__ >= __GH3X2X_INFO_LOG_LV_WARNING__)
...
#if (__GH3X2X_INFO_LOG_LEVEL__ >= __GH3X2X_INFO_LOG_LV_INFO__)
...
#if (__GH3X2X_INFO_LOG_LEVEL__ >= __GH3X2X_INFO_LOG_LV_DEBUG__)
