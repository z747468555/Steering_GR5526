...
#define __GH3X2X_INFO_LOG_LV_ERROR__            (1)    /** include EXAMPLE LOG error **/
#define __GH3X2X_INFO_LOG_LV_WARNING__          (2)    /** include EXAMPLE LOG waring **/
#define __GH3X2X_INFO_LOG_LV_INFO__             (3)    /** include EXAMPLE LOG information **/
#define __GH3X2X_INFO_LOG_LV_DEBUG__            (4)    /** include EXAMPLE LOG debug **/
#define __GH3X2X_INFO_LOG_LV_NB__               (0)    /** no log **/
