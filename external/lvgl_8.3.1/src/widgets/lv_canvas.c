...
void lv_canvas_draw_line2(lv_obj_t* canvas, const lv_coord_t pointsx[], const lv_coord_t pointsy[], uint32_t point_cnt, lv_draw_line_dsc_t* draw_dsc)
{
    LV_ASSERT_OBJ(canvas, MY_CLASS);
    ...
    for(i = 0; i < point_cnt - 1; i++) {
        ...
        lv_draw_line(driver.draw_ctx, draw_dsc, &p1, &p2);
    }
